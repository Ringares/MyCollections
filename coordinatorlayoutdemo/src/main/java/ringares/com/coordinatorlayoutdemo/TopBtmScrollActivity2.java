...
public class TopBtmScrollActivity2 extends AppCompatActivity {

    private RecyclerView rv;
    private DemoAdapter demoAdapter;

    public static void start(Context context) {
        Intent starter = new Intent(context, TopBtmScrollActivity2.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_top_btm_scroll_2);
